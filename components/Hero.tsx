        ...
        <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-14 px-4 pb-24 md:px-6 lg:grid-cols-[1fr_0.95fr]">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/72 md:text-xl">
              ...
              Ask questions, get instant insights, understand the game faster,
              and join the future of sports interaction.
            </p>
            ...
            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              <button
                ...
                className="button-glow inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-seer-violet via-seer-electric to-seer-pink px-7 py-4 text-center text-sm font-bold text-white transition hover:scale-[1.02]"
              >
                <Copy size={17} />
                Contract Address
              </button>
